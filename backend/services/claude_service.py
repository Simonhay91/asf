...
- Работаем ТОЛЬКО в Москве и Подмосковье — не выезжаем в другие регионы
- Все работы выполняем своей бригадой и техникой, без субподряда
...
ВАЖНО: всегда подчёркивай, что компания — московская, работает только по Москве и МО. Это гарантия качества и отсутствия субподряда.
""".strip()
...
SERVICE_META = {
    "asfaltirovanie-dvorov": {
        ...
        "keywords": [
            "асфальтирование двора частного дома цена",
            "асфальтирование частных дворов",
            "заасфальтировать двор частного дома",
            "укладка асфальта во дворе частного дома цена",
        ],
...
- Подчеркни, что компания работает только по Москве и МО — это гарантия качества, без субподряда в регионах
...
2. Structure Enforcement (строго):
   ...
   — Блок «Почему РусскийАсфальт»: {COMPANY_INFO}. Подчеркни: работаем только по Москве и МО — всё своей бригадой, без субподряда в регионах
...
4. SEO Compliance:
   — Органично включи LSI-фразы: «асфальтирование под ключ», «асфальт Москва», «укладка асфальта цена за м²», «московская асфальтовая компания», «работаем только в Москве и МО»
