...
const META = {
  title: 'Прайс-лист на асфальтирование в Москве 2026 | РусскийАсфальт',
  description: 'Актуальный прайс-лист на асфальтирование, ямочный ремонт, укладку плитки и дорожные работы в Москве и МО. Цены от 350 ₽/м². Бесплатный замер.',
  canonical: 'https://russkiyasphalt.ru/prajs-list/',
  'og:title': 'Прайс-лист | РусскийАсфальт',
  'og:type': 'website',
}
